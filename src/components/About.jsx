      ...
      <div className="about-container">
        <div className="about-grid">
          ...
          <div className="about-content">
            ...
            <p className="about-text">
              I specialize in Laravel for backend development and have
              experience with Angular for frontend development from my capstone
              project. I am currently completing my OJT, where I use Laravel as
              a full-stack framework, developing web applications using Blade
              for the frontend and focusing on clean, scalable solutions.
            </p>
